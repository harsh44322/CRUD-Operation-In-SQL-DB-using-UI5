					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "DB Crud Application",
									"targetURL": "#postgresql-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"postgresql-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=postgresql",
									"url": sap.ui.require.toUrl("postgresql")
								}
							}
						}
					}
